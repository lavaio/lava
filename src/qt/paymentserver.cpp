...
const QString BITCOIN_IPC_PREFIX("lavacoin:");
#ifdef ENABLE_BIP70
...
void PaymentServer::handleURIOrFile(const QString& s)
{
    ...
    if (s.startsWith("lavacoin://", Qt::CaseInsensitive))
    {
        Q_EMIT message(tr("URI handling"), tr("'lavacoin://' is not a valid URI. Use 'lavacoin:' instead."),
