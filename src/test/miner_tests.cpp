...
BOOST_AUTO_TEST_CASE(CreateNewBlock_validity)
{
    ...
    BOOST_CHECK(pblocktemplate = AssemblerForTest(chainparams).CreateNewBlock(scriptPubKey,0,0,0,MakeTransactionRef()));
    ...
    BOOST_CHECK_EXCEPTION(AssemblerForTest(chainparams).CreateNewBlock(scriptPubKey,0,0,0,MakeTransactionRef()), std::runtime_error, HasReason("bad-blk-sigops"));
    mempool.clear();
    ...
    BOOST_CHECK_EXCEPTION(AssemblerForTest(chainparams).CreateNewBlock(scriptPubKey,0,0,0,MakeTransactionRef()), std::runtime_error, HasReason("bad-txns-inputs-missingorspent"));
    mempool.clear();
    ...
    BOOST_CHECK_EXCEPTION(AssemblerForTest(chainparams).CreateNewBlock(scriptPubKey,0,0,0,MakeTransactionRef()), std::runtime_error, HasReason("bad-cb-multiple"));
    mempool.clear();
    ...
    BOOST_CHECK_EXCEPTION(AssemblerForTest(chainparams).CreateNewBlock(scriptPubKey,0,0,0,MakeTransactionRef()), std::runtime_error, HasReason("block-validation-failed"));
    mempool.clear();
