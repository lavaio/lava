// Copyright (c) 2019-2020 The Lava developers
...
/**
 * The input witness consists of four CA, three of which are
 * optional. The optional CA have to do with asset issuance
...
/**
 * The output witness consists of two CA: the surjection proof and
 * the range proof.
 *
