                                    ...
                                    unsigned int nIn, unsigned int flags, bitcoinconsensus_error* err)
{
    ...
    try {
        ...
        return VerifyScript(tx.vin[nIn].scriptSig, CScript(scriptPubKey, scriptPubKey + scriptPubKeyLen), &tx.vin[nIn].scriptWitness, flags, TransactionSignatureChecker(&tx, nIn, amount, txdata, false), nullptr);
