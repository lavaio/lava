...
public:
    ...
    std::unique_ptr<CBlockTemplate> CreateNewBlock(const CScript& scriptPubKeyIn, const uint64_t nonce, const CKeyID& nPublicKeyID, const uint64_t plotID, const uint64_t deadline, const CTransactionRef& tx);
