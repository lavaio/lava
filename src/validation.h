...
//! -maxtxfee default
static const CAmount DEFAULT_TRANSACTION_MAXFEE = COIN * 16;
...
/** Produce the necessary coinbase commitment for a CA block (modifies the hash, don't call for mined blocks). */
